...
import {
  ...
  DEPLACES_PAR_COLONNE,
  DEPLACES_PAR_SATELLITES_RESPAWN, EMPREINTES_PAR_GRAINE_SATELLITES_RESPAWN,
  ...
  OCTETS_AJOUTES_PAR_QUATRE_ETATS, OCTETS_AJOUTES_PAR_RAID_ET_ECRAN,
  ...
  for (const g of GRAINES) {
    ...
    assert.equal(
      ...
      attendu.tailleSauvegarde + OCTETS_AJOUTES_PAR_LE_DEPLIAGE + OCTETS_AJOUTES_PAR_BASES_1
        ...
        // ⚠ LE SIXIÈME TERME EST ENTRÉ AU LOT RAID-ET-ÉCRAN, 10/09 : un champ de
