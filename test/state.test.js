...
test('test 12 — une sauvegarde de version 0 traverse toute la chaîne, jusqu\'à la refondation', () => {
  ...
  assert.equal(SAVE_VERSION, 15, 'le bump de la version des sauvegardes a été oublié');
...
test('forces — une sauvegarde v6 se migre en v7 sans rien perdre', () => {
  ...
  assert.equal(migre.version, 15, 'la chaîne doit aller jusqu\'au bout, pas s\'arrêter à 7');
