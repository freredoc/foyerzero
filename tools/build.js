...
const FICHIERS_INLINE = [
  ...
  { marqueur: '%SOL_OUVRAGE_NATUREL_1%', chemin: ['art', 'sprites', 'sol', 'sol_ouvrage_naturel_1.webp'], type: 'image/webp' },
  { marqueur: '%SOL_OUVRAGE_NATUREL_2%', chemin: ['art', 'sprites', 'sol', 'sol_ouvrage_naturel_2.webp'], type: 'image/webp' },
  { marqueur: '%SOL_OUVRAGE_NATUREL_3%', chemin: ['art', 'sprites', 'sol', 'sol_ouvrage_naturel_3.webp'], type: 'image/webp' },
  { marqueur: '%SOL_OUVRAGE_NATUREL_4%', chemin: ['art', 'sprites', 'sol', 'sol_ouvrage_naturel_4.webp'], type: 'image/webp' },
  { marqueur: '%SOL_OUVRAGE_NATUREL_5%', chemin: ['art', 'sprites', 'sol', 'sol_ouvrage_naturel_5.webp'], type: 'image/webp' },
  { marqueur: '%SOL_OUVRAGE_NATUREL_6%', chemin: ['art', 'sprites', 'sol', 'sol_ouvrage_naturel_6.webp'], type: 'image/webp' },
  { marqueur: '%SOL_OUVRAGE_NATUREL_7%', chemin: ['art', 'sprites', 'sol', 'sol_ouvrage_naturel_7.webp'], type: 'image/webp' },
  { marqueur: '%SOL_OUVRAGE_HYBRIDE_1%', chemin: ['art', 'sprites', 'sol', 'sol_ouvrage_hybride_1.webp'], type: 'image/webp' },
  { marqueur: '%SOL_OUVRAGE_HYBRIDE_2%', chemin: ['art', 'sprites', 'sol', 'sol_ouvrage_hybride_2.webp'], type: 'image/webp' },
  { marqueur: '%SOL_OUVRAGE_HYBRIDE_3%', chemin: ['art', 'sprites', 'sol', 'sol_ouvrage_hybride_3.webp'], type: 'image/webp' },
  { marqueur: '%SOL_OUVRAGE_ARTIFICIEL_1%', chemin: ['art', 'sprites', 'sol', 'sol_ouvrage_artificiel_1.webp'], type: 'image/webp' },
  { marqueur: '%SOL_OUVRAGE_ARTIFICIEL_2%', chemin: ['art', 'sprites', 'sol', 'sol_ouvrage_artificiel_2.webp'], type: 'image/webp' },
  { marqueur: '%SOL_OUVRAGE_ARTIFICIEL_3%', chemin: ['art', 'sprites', 'sol', 'sol_ouvrage_artificiel_3.webp'], type: 'image/webp' },
  { marqueur: '%SOL_OUVRAGE_ARTIFICIEL_4%', chemin: ['art', 'sprites', 'sol', 'sol_ouvrage_artificiel_4.webp'], type: 'image/webp' },
  atlas('batiment'),
